...
function Button ({ path, isActive, icon, text }) {
  return (
    <Link
      to={path}
    ...
    >
      <svg
        className={`w-5 h-5 mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-500 ${isActive
      ...
      <span className={`text-sm group-hover:text-blue-600 dark:group-hover:text-blue-500 ${isActive
        ? 'text-blue-600 dark:text-blue-500'
        : 'text-gray-500 dark:text-gray-400'}`}
      >
              {text}
    ...
    <>
      <div
        ...
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
          ...
          <Button
            path={expensesPath}
            isActive={expensesPath === pathname}
            text="Gastos"
            icon={
              <>
                <path
